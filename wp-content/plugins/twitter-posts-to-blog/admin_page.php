<div class="wrap dgtw">
  ...
  <p>
                    <b><?= __('Users List','twitter-posts-to-blog') ?>:</b><br/>
                <p class="dg_tw_horiz">
                    <span class="description"><?= __('Does not post tweets of these users (separated by comma ",")','twitter-posts-to-blog') ?>:</span><br/>
                    <input type="text" size="60" name="dg_tw_gooduser" class="regular-text" value="<?php echo isset($dg_tw_ft['gooduser']) ? $dg_tw_ft['gooduser'] : ''; ?>">
                    <?php echo $dg_tw_ft['gooduser']; ?>
                </p>
                <br/>
                </p>

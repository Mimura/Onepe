...
<html>
    ...
    <body>
        <div id="main">
            <div id="content">
                <div class="header">
                    <a id="logo" href="http://www.hostinger.jp/"><img src="http://www.hostinger.jp/images/logo-jp.png" alt="Web hosting" /></a>
                </div>
                <div class="content">
                    <h1>お客様のアカウントは問題なく作成されました。</h1>
                    <p><? print $host; ?> のホームページは、サーバー上に問題なく作成されました。<b>public_html</b>フォルダー内にある<b>default.php</b>を削除してから、FTP、またはファイルマネージャー経由でお客様のホームページの内容をアップロードしてください。</p>
                    <p>お客様のpublic_htmlフォルダー内にあるファイルは以下の通りです：</p>
                    <div id="files">
                        <div class="top"></div>
                        <div class="cont">
            ...
            <div id="footer">
                <div class="links">
                    <a href="http://www.hostinger.jp/web-hosting" target="_blank">レンタルサーバー</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.jp/free-hosting" target="_blank">無料レンタルサーバー</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.jp/forum" target="_blank">サポート・フォーラム</a> 
                    <span class="pipe">|</span> 
                    <a href="http://cpanel.hostinger.jp/" target="_blank">ログインしてください</a>
                </div>
                <div class="copyright">Hostinger 日本 &copy; <? print date('Y'); ?>. All rights reserved</div>
                <div class="social-icons">
                    <a href="http://www.facebook.com/Hostinger.JP"><img src="http://www.main-hosting.com/hostinger/welcome/images/fb.gif" /></a>
